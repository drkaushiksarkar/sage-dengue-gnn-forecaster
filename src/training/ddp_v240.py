...
class DdpV240(nn.Module):
    """Neural network module for ddp_v240 v2.
    ...
    def __init__(self, config: Optional[DdpV240Config] = None):
        super().__init__()
        self.config = config or DdpV240Config()
        c = self.config
        ...
        logger.info("Initialized DdpV240 v2 with %d params",
