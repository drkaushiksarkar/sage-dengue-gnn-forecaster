...
class DdpV225(nn.Module):
    """Neural network module for ddp_v225 v2.
    ...
    def __init__(self, config: Optional[DdpV225Config] = None):
        super().__init__()
        self.config = config or DdpV225Config()
        c = self.config
        ...
        logger.info("Initialized DdpV225 v2 with %d params",
