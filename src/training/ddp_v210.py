...
class DdpV210(nn.Module):
    """Neural network module for ddp_v210 v2.
    ...
    def __init__(self, config: Optional[DdpV210Config] = None):
        super().__init__()
        self.config = config or DdpV210Config()
        c = self.config
        ...
        logger.info("Initialized DdpV210 v2 with %d params",
