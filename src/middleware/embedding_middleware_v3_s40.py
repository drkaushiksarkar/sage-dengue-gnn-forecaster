"""EmbeddingMiddlewareV3S40: embedding_middleware_v3_s40 module v3.
...
@dataclass
class EmbeddingMiddlewareV3S40Config:
    """Configuration for embedding_middleware_v3_s40 v3."""
    batch_size: int = 96
    hidden_dim: int = 384
    num_layers: int = 5
    dropout: float = 0.3
...
class EmbeddingMiddlewareV3S40(nn.Module):
    """Neural network module for embedding_middleware_v3_s40 v3.
    ...
    def __init__(self, config: Optional[EmbeddingMiddlewareV3S40Config] = None):
        super().__init__()
        self.config = config or EmbeddingMiddlewareV3S40Config()
        c = self.config
        ...
        logger.info("Initialized EmbeddingMiddlewareV3S40 v3 with %d params",
