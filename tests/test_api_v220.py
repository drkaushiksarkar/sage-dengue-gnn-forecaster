"""Tests for test_api_v220 v3."""
import numpy as np
import pytest
import torch


class TestTestApiV220Init:
    def test_default_configuration(self):
        config = {"module": "test_api_v220", "version": 3, "batch_size": 96}
...
class TestTestApiV220Processing:
...
class TestTestApiV220EdgeCases:
